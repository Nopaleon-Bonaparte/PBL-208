...
<aside class="sidebar">
  ...
  <div class="sidebar-header">
    ...
    <div class="sidebar-app">
      ...
      <span class="sidebar-app-name">Pengurus<br>Masjid</span>
    </div>

    {{-- Org / masjid --}}
    <div class="sidebar-org">
      <div class="sidebar-org-icon">M</div>
      <span class="sidebar-org-name">{{ session('nama_masjid', 'Masjid Agung Batam') }}</span>
    </div>
  </div>

  <a href="{{ url('/masjid/informasi') }}"
     class="nav-item {{ ($activeNav ?? '') === 'informasi' ? 'active' : '' }}">
    <i class="ti ti-info-circle"></i><span>Informasi Masjid</span>
  </a>

  <div class="nav-spacer"></div>

  <a href="{{ url('/masjid/settings') }}"
