...
<header class="topbar">
  ...
  <div class="topbar-left">
    <nav class="topbar-breadcrumb">
      ...
      <a href="{{ url('/masjid/informasi') }}">Pages</a>
      <span class="bc-sep">›</span>
      <span class="bc-current">
        @php
          $navLabels = [
            'informasi' => 'Informasi Masjid',
            'settings'  => 'Pengaturan',
          ];
          echo $navLabels[$activeTopLink ?? ''] ?? 'Informasi Masjid';
        @endphp
      </span>
    </nav>
  </div>
  ...
  <div class="topbar-right">
    <a href="{{ url('/masjid/settings') }}" class="tb-icon-btn"><i class="ti ti-settings"></i></a>
    ...
    <div class="tb-profile-wrap" id="profileWrap">
      ...
      <div class="tb-profile-popup" id="profilePopup">
        ...
        <div class="tb-popup-grid">
          ...
          <div class="tb-popup-field">
            <label>Masjid</label>
            <div class="tb-popup-value">{{ session('nama_masjid', '-') }}</div>
          </div>
        </div>
