...
<title>Pengaturan — PCM Administration</title>
...
<div class="app-shell">
  ...
  @include('admin_cabang.sidebar', ['activeNav' => 'settings'])

  <div class="main-shell">
    @include('admin_cabang.topbar', ['activeTopLink' => 'settings'])
      ...
      <form action="{{ route('settings.save') }}" method="POST">
        ...
        <div class="page-header">
          <div class="page-header-left">
            <h1>Pengaturan</h1>
            <p>Kelola informasi profil akun admin cabang.</p>
          </div>
        ...
        <div class="settings-card">
          ...
          <div class="settings-grid">
            ...
            <div class="settings-field">
              <label>No. HP</label>
              <input type="text" name="no_hp" id="pcmHpInput" value="{{ old('no_hp', $user->no_hp) }}">
            </div>
            <div class="settings-field">
...
<script>
const hpInput = document.getElementById('pcmHpInput');
if (hpInput) {
