...
<title>Indeks Aktivitas Ranting — PCM Administration</title>
...
<div class="app-shell">
  ...
  @include('admin_cabang.sidebar', ['activeNav' => 'ranting-status'])

  <div class="main-shell">
    @include('admin_cabang.topbar', ['activeTopLink' => 'ranting-status'])
...
<div class="modal-overlay" id="modalOverlay" onclick="closeOnBg(event)">
  <div class="modal-box">
    ...
    <form method="POST" action="{{ url('/pcm/ranting-status/store') }}" onsubmit="handleSubmit(event)">
      @csrf
