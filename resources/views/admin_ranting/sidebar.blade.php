...
<aside class="sidebar">
  ...
  <div class="sidebar-header">
    ...
    <div class="sidebar-app">
      ...
      <span class="sidebar-app-name">Pimpinan Ranting<br>Muhammadiyah</span>
    </div>

    {{-- Org / ranting --}}
    <div class="sidebar-org">
      <div class="sidebar-org-icon">R</div>
      <span class="sidebar-org-name">{{ session('nama_ranting', 'PRM') }}</span>
    </div>
  </div>

  <a href="{{ url('/prm/membership') }}"
     class="nav-item {{ ($activeNav ?? '') === 'dashboard' ? 'active' : '' }}">
    <i class="ti ti-layout-dashboard"></i><span>Dashboard</span>
  </a>

  <a href="{{ url('/prm/data-masjid') }}"
     class="nav-item {{ ($activeNav ?? '') === 'data-masjid' ? 'active' : '' }}">
